...
sudo scutil --set ComputerName "hobbes-personal"

# Standby delay in seconds
sudo pmset -a standbydelay 3600

# Disable sounds effects on boot
...
# Trackpad: speed
defaults write com.apple.trackpad.scaling -float 1

# Trackpad: enable three fingers drag/resize
...
# Use the cover flow view in all Finder windows by default
